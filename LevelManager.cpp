...
int** LevelManager::nextLevel(VertexArray& rVaLevel)
{
	...
	//prepare 2D array to hold the int values from the file
	int** arrayLevel = new int* [m_LevelSize.y];
	for (int i = 0; i < m_LevelSize.y; ++i)
	{
		// Add new array into each array element
		arrayLevel[i] = new int[m_LevelSize.x];
	}

	//Loop through file and store all
	...
	//What type of premitives are we using?
